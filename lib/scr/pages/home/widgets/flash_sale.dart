...
import 'package:flutter_clone_shopee/scr/models/flash_sale_model.dart';
import 'package:flutter_clone_shopee/scr/utils/format.dart';
import 'package:flutter_clone_shopee/scr/viewmodels/flash_sale_view_model.dart';
import 'package:flutter_clone_shopee/scr/widgets/discount_painter.dart';
    ...
    return Stack(
      ...
      children: [
        LinearPercentIndicator(
          center: Text(
            "ຂາຍແລ້ວ ${Format().currency(flashSale.sold.toDouble(), decimal: false)}",
            style: TextStyle(
              color: Colors.white,
              fontSize: 12,
            ),
