...
class _BannerSectionState extends State<BannerSection> {
  final List<String> _imgList = [
    ...
    'assets/images/banner_9.jpg',
    'assets/images/banner_10.jpg',
    'assets/images/banner_11.jpg',
    'assets/images/banner_12.jpg',
    'assets/images/banner_13.jpg',
  ];
        ...
        child: Row(
          children: [
            ...
            _buildInfo(
                ...
                subTitle: "ຊື້ຕອນນີ້ ຮັບສ່ນວນທັນທີ 20%",
                isCoin: true),
            verticalDivider,
            _buildInfo(
              image:
                  "https://www.pngrepo.com/png/167109/180/dollar-coin-circle-with-symbol.png",
              title: "\$${Format().currency(5000.00)}",
              subTitle: "ໃຊ້ໄດ້ຮອດທ້າຍເດີືອນນີ້ !!",
              isCoin: true,
            ),
          ],
        ),
